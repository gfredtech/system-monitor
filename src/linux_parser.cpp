...
template <typename T>
T readValueFromFile(const string &path, const string &argumentName) {
  T value;
...
long LinuxParser::ActiveJiffies() { std::vector <long> cpuJiffies = CpuUtilization();
